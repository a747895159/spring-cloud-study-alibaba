...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("用法：fill_pdf_form_with_annotations.py [输入PDF] [fields.json] [输出PDF]")
        sys.exit(1)
